package net.silentchaos512.tutorial.util;
...
public class LocalizationHelper {
   ...
   */
  public static final String MISC_PREFIX = "misc." + TutorialMod.RESOURCE_PREFIX; // misc.tutorialmod:
  /**
   * Prefix for item keys.
   */
  public static final String ITEM_PREFIX = "item." + TutorialMod.RESOURCE_PREFIX; // item.tutorialmod:
  /**
   * Prefix for block (tile) keys.
   */
  public static final String BLOCK_PREFIX = "tile." + TutorialMod.RESOURCE_PREFIX; // tile.tutorialmod:
